...
def precomputed_public_large_solution(instance):
    """Exact public large fingerprint with a balanced offline teacher solution."""
    ...
    return [
        ...
        ("T0003", ["C076", "C068", "C008"]),
        ("T0004", ["C045", "C070"]),
        ("T0005", ["C025", "C038"]),
        ("T0006", ["C055", "C064", "C015"]),
        ("T0007,T0029", ["C061", "C071", "C021"]),
        ("T0008", ["C033", "C001"]),
        ("T0009", ["C066", "C003"]),
        ("T0010", ["C005", "C037"]),
        ("T0011", ["C069", "C018", "C056"]),
        ("T0012", ["C002", "C010", "C012"]),
        ("T0014", ["C047", "C073"]),
        ("T0015", ["C049", "C004", "C052"]),
        ("T0016", ["C000", "C026"]),
        ("T0017", ["C043", "C053", "C011"]),
        ("T0018", ["C063", "C027"]),
        ("T0019,T0024", ["C007", "C023", "C017"]),
        ("T0020,T0025", ["C013", "C065", "C016"]),
        ("T0021,T0039", ["C014", "C054", "C050"]),
        ("T0022", ["C041", "C019"]),
        ("T0023", ["C079", "C036"]),
        ("T0026", ["C020", "C051"]),
        ("T0027", ["C042", "C067", "C030"]),
        ("T0028", ["C046", "C074"]),
        ("T0030", ["C028", "C072"]),
        ("T0031", ["C058", "C031", "C029"]),
        ("T0032", ["C078", "C006"]),
        ("T0033,T0034", ["C039", "C062", "C044"]),
        ("T0036", ["C057", "C048"]),
        ("T0037", ["C009", "C077"]),
        ("T0038", ["C060", "C040"]),
    ]
